...
<table>
    ...
    <tr>
        <td>Participante#<%=++i %>: <%=participante.getNome() %> |
            <a href='participanteServlet?acao=edita&idParticipante=<%=participante.getIdParticipante() %>'>
                Editar</a> |
            <a href='participanteServlet?acao=apaga&idParticipante=<%=participante.getIdParticipante() %>'>Apagar</a>
        </td>
    </tr>
    <% }
   %>
