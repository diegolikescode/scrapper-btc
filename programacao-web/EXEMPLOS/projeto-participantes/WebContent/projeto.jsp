...
<body>
	...
	<form action="projetoServlet">
		<input type="hidden" name="acao" value="salva" /> <input type="hidden"
			name="idProjeto"
		...
		Descrição <input type="text" name="descProjeto" id="idProjeto"
			value="<%=projeto != null ? projeto.getDescricao() : ""%>" /><br> Data
		Inicio: <input type="date" name="dataInicio" id="idInicio"
			value="<%=projeto != null ? projeto.getDataInicioFormatada() : ""%>"><br>
		Data Fim: <input type="date" name="dataFim" id="idFim"
			value="<%=projeto != null ? projeto.getDataFimFormatada() : ""%>"><br>
		Percentual Concluído: <input type="number" name="percConcluido"
			id="idPercConcluido"
		...
		%>
		Participante: <select name="participantes" size="5" multiple>
			<%
