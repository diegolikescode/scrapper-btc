...
<table>
    ...
    <tr>
        <td>
            Projeto#<%=++i%>: <%=projeto.getDescricao()%> |
            <a href="projetoServlet?acao=edita&idProjeto=<%=projeto.getIdProjeto()%>">Editar</a> |
            <a href="projetoServlet?acao=apaga&idProjeto=<%=projeto.getIdProjeto()%>">Apagar</a>
