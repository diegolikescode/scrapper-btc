...
import br.unisul.aula.dao.jpa.ParticipanteImpl;
import br.unisul.aula.dao.jpa.ProjetoImpl;
...
public class ParticipanteServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (acao.equals("salva")) {
            ...
            {
                int id = !request.getParameter("idParticipante").equals("")?Integer.parseInt(request.getParameter("idParticipante")):0;
                if (id>0) {
                    alterarParticipante(request, response);
                } else {
    ...
    public void alterarParticipante(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            Participante participante = preencheParticipante(request);
