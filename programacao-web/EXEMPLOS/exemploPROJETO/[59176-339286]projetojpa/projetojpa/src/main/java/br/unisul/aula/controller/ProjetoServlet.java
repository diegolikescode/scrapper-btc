...
public class ProjetoServlet extends HttpServlet {
    ...
    private ProjetoDAO dao = new ProjetoImpl();
    ...
    private ParticipanteDAO participanteDAO = new ParticipanteImpl();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (request.getParameter("idProjeto")!=null){
         if (acao.equalsIgnoreCase("salva")) {
             int id =
                     !request.
getParameter("idProjeto").equals("")? Integer.parseInt(request.getParameter("idProjeto")) : 0;
             if (id > 0) {
                 alterarProjeto(request, response);
             } else {
    ...
    private void alterarProjeto(HttpServletRequest request, HttpServletResponse response) {
